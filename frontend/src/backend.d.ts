...
export interface TravelStyleUpdate {
    name: string;
    description: string;
    baseImage: string;
}
...
export interface backendInterface {
    ...
    addTravelStyle(travelStyle: TravelStyle): Promise<void>;
    ...
    deleteTravelStyle(id: string): Promise<void>;
    ...
    getAllTravelStyles(): Promise<Array<TravelStyle>>;
    ...
    updateTravelStyle(update: TravelStyleUpdate): Promise<void>;
}
