...
import type { AdminSettings as _AdminSettings, BlogPost as _BlogPost, InstagramFeedItem as _InstagramFeedItem, Time as _Time, TravelStyle as _TravelStyle, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addTravelStyle(arg0: TravelStyle): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addTravelStyle(to_candid_TravelStyle_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteTravelStyle(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteTravelStyle(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllTravelStyles(): Promise<Array<TravelStyle>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllTravelStyles();
    ...
    async updateBlogPost(arg0: BlogPost): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateBlogPost(to_candid_BlogPost_n14(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateTravelStyle(arg0: TravelStyleUpdate): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateTravelStyle(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_BlogPost_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _BlogPost): BlogPost {
    return from_candid_record_n19(_uploadFile, _downloadFile, value);
}
function from_candid_InstagramFeedItem_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _InstagramFeedItem): InstagramFeedItem {
    return from_candid_record_n24(_uploadFile, _downloadFile, value);
}
function from_candid_TravelStyle_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _TravelStyle): TravelStyle {
...
function from_candid_opt_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_AdminSettings]): AdminSettings | null {
...
function from_candid_opt_n31(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_BlogPost]): BlogPost | null {
    return value.length === 0 ? null : from_candid_BlogPost_n18(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        tags: value.tags,
        publishedAt: record_opt_to_undefined(from_candid_opt_n20(_uploadFile, _downloadFile, value.publishedAt)),
        directPublish: value.directPublish,
        author: value.author,
        coverImage: record_opt_to_undefined(from_candid_opt_n21(_uploadFile, _downloadFile, value.coverImage)),
        timestamp: value.timestamp,
        excerpt: value.excerpt,
        scheduledAt: record_opt_to_undefined(from_candid_opt_n20(_uploadFile, _downloadFile, value.scheduledAt)),
        images: value.images
    };
}
...
function from_candid_record_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        timestamp: value.timestamp,
        baseImage: record_opt_to_undefined(from_candid_opt_n21(_uploadFile, _downloadFile, value.baseImage))
    };
}
...
function from_candid_tuple_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [Principal, [] | [_UserProfile]]): [Principal, UserProfile | null] {
    return [
        value[0],
        from_candid_opt_n30(_uploadFile, _downloadFile, value[1])
    ];
}
...
function from_candid_vec_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_BlogPost>): Array<BlogPost> {
    return value.map((x)=>from_candid_BlogPost_n18(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_InstagramFeedItem>): Array<InstagramFeedItem> {
    return value.map((x)=>from_candid_InstagramFeedItem_n23(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_TravelStyle>): Array<TravelStyle> {
    return value.map((x)=>from_candid_TravelStyle_n26(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[Principal, [] | [_UserProfile]]>): Array<[Principal, UserProfile | null]> {
...
function to_candid_TravelStyle_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: TravelStyle): _TravelStyle {
...
function to_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        description: value.description,
        timestamp: value.timestamp,
        baseImage: value.baseImage ? candid_some(value.baseImage) : candid_none()
    };
}
