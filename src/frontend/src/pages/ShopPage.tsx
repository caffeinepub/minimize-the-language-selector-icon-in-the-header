...
import { ShoppingBag, Home, ExternalLink, X, Star, Search, Filter, Calendar } from 'lucide-react';
import { useGetPublishedShopProducts } from '../hooks/useQueries';
...
export default function ShopPage() {
  ...
  const { data: shopProducts, isLoading } = useGetPublishedShopProducts();
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center space-x-3 mb-4">
            ...
            <h1 className="text-3xl font-bold text-secondary">{t('shop.title')}</h1>
          </div>

          <div className="bg-white rounded-lg p-4 mb-6 shadow-sm max-w-2xl mx-auto">
          ...
          <div className="text-center py-16">
            <div className="max-w-md mx-auto">
              ...
              <h3 className="text-2xl font-bold text-secondary mb-4">
                {searchTerm ? t('shop.noProductsFound') : t('shop.comingSoon')}
              </h3>
              <p className="text-secondary-light mb-6 leading-relaxed">
                {searchTerm 
                  ? t('shop.noProductsFoundDescription')
